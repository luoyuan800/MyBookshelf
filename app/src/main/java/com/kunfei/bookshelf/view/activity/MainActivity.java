...
public class MainActivity extends BaseTabActivity<MainContract.Presenter> implements
    MainContract.View, BookListFragment.CallbackValue {
  ...
  protected void bindView() {
    ...
    //点击跳转搜索页
    cardSearch
        .setOnClickListener(view -> startActivityByAnim(new Intent(this, SearchBookActivity.class),
  ...
  private void initTabLayout() {
    ...
    for (int i = 0; i < mTlIndicator.getTabCount(); i++) {
      ...
      tab.setContentDescription(
          String.format("%s,%s", tv.getText(), getString(R.string.click_on_selected_show_menu)));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (id) {
      case R.id.action_add_local:
        PermissionUtils.checkMorePermissions(this, MApplication.PerList,
            new PermissionUtils.PermissionCheckCallback() {
              ...
              public void onAlreadyTurnedDownAndNoAsk(String... permission) {
                ...
                PermissionUtils
                    .requestMorePermissions(MainActivity.this, permission, FILE_SELECT_RESULT);
              }
            });
        break;
  ...
  private void setUpNavigationView() {
    NavigationViewUtil
        .setItemTextColors(navigationView, getResources().getColor(R.color.tv_text_default),
            ThemeStore.accentColor(this));
    NavigationViewUtil
        .setItemIconColors(navigationView, getResources().getColor(R.color.tv_text_default),
            ThemeStore.accentColor(this));
    NavigationViewUtil.disableScrollbar(navigationView);
    @SuppressLint("InflateParams") View headerView = LayoutInflater.from(this)
        .inflate(R.layout.navigation_header, null);
    navigationView.addHeaderView(headerView);
    Menu drawerMenu = navigationView.getMenu();
    vwNightTheme = drawerMenu.findItem(R.id.action_theme).getActionView()
        .findViewById(R.id.iv_theme_day_night);
    upThemeVw();
    ...
    navigationView.setNavigationItemSelectedListener(menuItem -> {
      ...
      switch (menuItem.getItemId()) {
        case R.id.show_reading_time:
          handler.postDelayed(() -> {
            final AlertDialog.Builder readingTimeDialog =
                new AlertDialog.Builder(MainActivity.this);
            readingTimeDialog.setIcon(R.drawable.ic_time_add_24dp);
            readingTimeDialog.setTitle(R.string.reading_time_dialog_tile);
            readingTimeDialog
                .setMessage(Html.fromHtml(ReadingTimeUtil.getReadingTimeContent(this)));
            readingTimeDialog.setPositiveButton("确定",
                (dialog, which) -> dialog.cancel());
            // 显示
            readingTimeDialog.show();
          }, 200);
          break;
  ...
  private void upThemeVw() {
    ...
    vwNightTheme.getDrawable().mutate()
        .setColorFilter(ThemeStore.accentColor(this), PorterDuff.Mode.SRC_ATOP);
  }
